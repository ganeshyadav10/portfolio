      ...
      <div className="contact-body">
        <Grid className="contact-grid">
          ...
          <Cell col={6}>
              ...
              <List>
                  <ListItem>
                      <ListItemContent style={{fontSize: '25px', fontFamily: 'Anton'}}><i className="fa fa-phone-square" aria-hidden='true'></i>6305443421</ListItemContent>
                  </ListItem>
                  <ListItem>
                      <ListItemContent style={{fontSize: '25px', fontFamily: 'Anton'}}><i className="fa fa-envelope" aria-hidden='true'></i>ganayadav369@gmail.com</ListItemContent>
                  </ListItem>
              </List>
              </div>
          </Cell>
